export default function T1() {
  return (
    <main style={s.screen}>
      <div style={s.card}>
        <div style={s.step}>Krok 1 z 3</div>
        <div style={s.icon}>🎙️</div>
        <div style={s.title}>Stačí hovoriť</div>
        <div style={s.sub}>Aplikácia počúva automaticky. Nemusíte nič stláčať.</div>
        <a href="/tutorial/2" style={s.primary}>Pokračovať</a>
      </div>
    </main>
  );
}
